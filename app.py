...
redisPubSub = redis.StrictRedis(host='localhost', port=6379, db=0, decode_responses=True)
...
def createAuction():
    ...
    #Conexão com o redis
    redisCon = redis.StrictRedis(host='localhost', port=6379, db=0, decode_responses=True)
