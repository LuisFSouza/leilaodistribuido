...
def createAuction():
    ...
    if(lock.acquire()):
        try:
            ...
            diffseconds = int((data - datetime.now(ZoneInfo("America/Sao_Paulo"))).total_seconds());
    ...
    try:
        ...
        for chave in chaves_leiloes:
            ...
            dadosLeilaoEspecifico = {
                ...
                "ativo": "Não" if datetime.fromisoformat(dadosLeilao["horariotermino"]) < datetime.now(ZoneInfo("America/Sao_Paulo")) else "Sim"
            }
    ...
    if(lock.acquire()):
        try:
            ...
            if(redisCon.exists(f'leilao-{leilao}')):
                ...
                if(datetime.fromisoformat(leilaoRedis['horariotermino']) < datetime.now(ZoneInfo("America/Sao_Paulo"))):
    ...
    try:
        ...
        if(redisCon.exists(f'leilao-{auction_id}')):
            ...
            dadosLeilao = {
                ...
                "leilao": auction_id,
                "ativo": "Não" if datetime.fromisoformat(dadosLeilaoRedis["horariotermino"]) < datetime.now(ZoneInfo("America/Sao_Paulo")) else "Sim"
            }
